...
proc generate {drv_handle} {
    puts "Generating Macros for rate_change_filters_txrx_2ch_plbw driver access ... "
    ...
    eval xdefine_include_file $drv_handle "xparameters.h" "RATE_CHANGE_FILTERS_TXRX_2CH_PLBW" "NUM_INSTANCES" ${xparam_config_table}
    eval sg_xdefine_include_file $drv_handle "xparameters.h" "RATE_CHANGE_FILTERS_TXRX_2CH_PLBW" ${addr_config_table}
    # generate rate_change_filters_txrx_2ch_plbw_g.c
    eval xdefine_config_file $drv_handle "rate_change_filters_txrx_2ch_plbw_g.c" "RATE_CHANGE_FILTERS_TXRX_2CH_PLBW" ${config_table}
}
...
proc sg_xdefine_include_file {drv_handle file_name drv_string args} {
    ...
    foreach periph ${periphs} {
        ...
        puts $file_handle "#define XPAR_[string toupper [xget_hw_name ${periph}]]_XC_CREATE    xc_rate_change_filters_txrx_2ch_plbw_create"
        puts $file_handle "#define XPAR_[string toupper [xget_hw_name ${periph}]]_XC_RELEASE   xc_rate_change_filters_txrx_2ch_plbw_release"
        puts $file_handle "#define XPAR_[string toupper [xget_hw_name ${periph}]]_XC_OPEN      xc_rate_change_filters_txrx_2ch_plbw_open"
        puts $file_handle "#define XPAR_[string toupper [xget_hw_name ${periph}]]_XC_CLOSE     xc_rate_change_filters_txrx_2ch_plbw_close"
        puts $file_handle "#define XPAR_[string toupper [xget_hw_name ${periph}]]_XC_READ      xc_rate_change_filters_txrx_2ch_plbw_read"
        puts $file_handle "#define XPAR_[string toupper [xget_hw_name ${periph}]]_XC_WRITE     xc_rate_change_filters_txrx_2ch_plbw_write"
        puts $file_handle "#define XPAR_[string toupper [xget_hw_name ${periph}]]_XC_GET_SHMEM xc_rate_change_filters_txrx_2ch_plbw_getshmem"
