...
function fec_decoder_simOnly_config(this_block)

  % Revision History:
  %
  %   20-Apr-2012  (12:19 hours):
  %     Original code was machine generated by Xilinx's System Generator after parsing
  %     C:\work\PHY\MIMO_OFDM\sysgen13p4\fec_decoder_simOnly.v
  %
  %

  this_block.setTopLevelLanguage('Verilog');

  this_block.setEntityName('fec_decoder_simOnly');
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  this_block.addFile('fec_decoder_simOnly.v');
%  this_block.addFile('fec_decoder_rest.v');
return;
